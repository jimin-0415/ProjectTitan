...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::BuffData, remiantime_),
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\006buffId\030\001 \001(\004\022\022\n\nremianTime\030\002 \001(\002\022\017\n\007vi"
...
BuffData::BuffData(const BuffData& from)
  ...
  ::memcpy(&buffid_, &from.buffid_,
    static_cast<size_t>(reinterpret_cast<char*>(&remiantime_) -
    reinterpret_cast<char*>(&buffid_)) + sizeof(remiantime_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&remiantime_) -
    reinterpret_cast<char*>(&buffid_)) + sizeof(remiantime_));
}
...
// @@protoc_insertion_point(message_clear_start:Protocol.BuffData)
  ...
  ::memset(&buffid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&remiantime_) -
      reinterpret_cast<char*>(&buffid_)) + sizeof(remiantime_));
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 21)) {
          remiantime_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* BuffData::_InternalSerialize(
  ...
  // float remianTime = 2;
  if (!(this->_internal_remiantime() <= 0 && this->_internal_remiantime() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(2, this->_internal_remiantime(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Protocol.BuffData)
  ...
  if (!(from._internal_remiantime() <= 0 && from._internal_remiantime() >= 0)) {
    _internal_set_remiantime(from._internal_remiantime());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void BuffData::InternalSwap(BuffData* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BuffData, remiantime_)
      + sizeof(BuffData::remiantime_)
