...
class BuffData final :
 ...
 public:
  ...
  // float remianTime = 2;
  void clear_remiantime();
  float remiantime() const;
  void set_remiantime(float value);
  private:
  float _internal_remiantime() const;
  void _internal_set_remiantime(float value);
  public:
...
// float remianTime = 2;
inline void BuffData::clear_remiantime() {
  remiantime_ = 0;
}
inline float BuffData::_internal_remiantime() const {
  return remiantime_;
}
inline float BuffData::remiantime() const {
  // @@protoc_insertion_point(field_get:Protocol.BuffData.remianTime)
  return _internal_remiantime();
}
inline void BuffData::_internal_set_remiantime(float value) {
  
  remiantime_ = value;
}
inline void BuffData::set_remiantime(float value) {
  _internal_set_remiantime(value);
  // @@protoc_insertion_point(field_set:Protocol.BuffData.remianTime)
}
